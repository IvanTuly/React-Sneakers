...
function Card({
  ...
  const { isItemAdded, isItemFavorited, currency } =
  ...
  const onClickPlus = () => {
    ...
    onPlus({ id, parentId, title, price, priceEur, imageUrl });
  };

  const onClickFavorite = () => {
    onFavorite({ id, parentId, title, price, priceEur, imageUrl });
            ...
            <img
              ...
              src={
                isItemFavorited(parentId)
                  ? process.env.PUBLIC_URL + "/img/heart-button-on.svg"
                  : process.env.PUBLIC_URL + "/img/heart-button-off.svg"
              }
              alt="Like"
            />
            <p className={styles.price}>
              {currency === "$" ? price + " $" : priceEur + " €"}
            </p>
          </div>
            ...
            <img
              ...
              src={
                isItemAdded(parentId)
                  ? process.env.PUBLIC_URL + "/img/addButtonOn.svg"
                  : process.env.PUBLIC_URL + "/img/addButtonOff.svg"
              }
              alt="Plus Button"
            />
          )}
